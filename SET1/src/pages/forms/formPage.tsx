...
function FormPage() {
  ...
  const handleFormSave = async (event: React.MouseEvent<HTMLElement>) => {
    ...
    if(currentStepIndex == 3) {
      ...
      if(form1.formState.isSubmitSuccessful) {
        navigate('/posts');
      }
  ...
  return (
    <div className='mx-10'>
      <div className='my-2'><Button onClick={()=> navigate('/posts')}>Got to Posts</Button></div>
      <div className="w-full flex items-center justify-center flex-col">
        <div className='m-5 p-2 w-full flex justify-around'>
          <Button type='button' variant={currentStepIndex == 1 ? 'default' : 'outline'} onClick={()=> goTo(1)} className="shadow-md shadow-blue-600">Step 1</Button>
          <Button type='button' variant={currentStepIndex == 2 ? 'default' : 'outline'} onClick={()=> goTo(2)} className="shadow-md shadow-blue-600">Step 2</Button>
          <Button type='button' variant={currentStepIndex == 3 ? 'default' : 'outline'} onClick={()=> goTo(3)} className="shadow-md shadow-blue-600">Step 3</Button>
        </div>
